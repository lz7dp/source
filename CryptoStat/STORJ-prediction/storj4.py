...
url = 'https://www.coingecko.com/price_charts/export/storj/usd.csv'
...
if response.status_code == 200:
    ...
    with open('storj-usd-max.csv', 'wb') as file:
...
plt.grid(True)
plt.show()
df.to_csv('processed1_storj_data.csv')
...
plt.grid(True)
plt.show()
df.to_csv('processed2_storj_data.csv')
...
plt.grid(True)
plt.show()
df.to_csv('processed3_storj_data.csv')
...
df.to_csv('processed4_storj_data.csv')
